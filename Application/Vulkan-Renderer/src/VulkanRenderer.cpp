...
void VulkanRenderer::updateUniformBuffer(uint32_t currentImage) 
{
	...
	UniformBufferObject ubo{};
		if (isControllerConnected) {
			transform.rotation.y = glm::radians((float)(((360-rot_x)+45)%360));
			transform.rotation.x = glm::radians((float)(rot_y));
			transform.rotation.z = glm::radians((float)(rot_z));
		} else {
        ...
        ubo.view = glm::lookAt(glm::vec3(3.0f, 3.0f, 3.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.5f, 0.0f));
